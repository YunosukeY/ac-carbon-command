...
from src.main import url_validation, get_submission_id, get_soup, get_submission_code, get_submission_info, get_contest_title, get_lang_para, get_carbon_image, get_tweet_title
...
int main() {\r
  ...
  def test_get_contest_title(self):
    test_patterns = [
      ('https://atcoder.jp/contests/abc170/submissions/14351771', 'AtCoder Beginner Contest 170'),
      ('https://atcoder.jp/contests/abc170/submissions/14351771?lang=ja', 'AtCoder Beginner Contest 170'),
      ('https://atcoder.jp/contests/abc170/submissions/14351771?lang=en', 'AtCoder Beginner Contest 170'),
      ('https://atcoder.jp/contests/tokiomarine2020/submissions/14219032', 'Tokio Marine & Nichido Fire Insurance Programming Contest 2020'),
      ('https://atcoder.jp/contests/tokiomarine2020/submissions/14219032?lang=ja', '東京海上日動 プログラミングコンテスト2020'),
    ]
    for url, ans in test_patterns:
      with self.subTest(url=url, ans=ans):
